...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::unprepared(
            '
            CREATE TRIGGER calculate_age_in_months_history BEFORE INSERT ON history_of_individual_records
            FOR EACH ROW
            BEGIN
        ...
        DB::unprepared(
            '
            CREATE TRIGGER calculate_weight_for_age_status_history BEFORE INSERT ON history_of_individual_records
                FOR EACH ROW
                    BEGIN
