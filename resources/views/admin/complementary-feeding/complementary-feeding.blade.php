...
<div id="enrollmentNotificationModal" class="modal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content" id="uploadCollapseModal">
            ...
            <div class="modal-body">
                ...
                <div class="d-flex justify-content-between">
                    <h5 class="card-title fw-semibold mb-4 text-black">► Enrollment Notification</h5>
                </div>
...
{{-- END OF ENROLLMENT NOTIFICATION FORM --}} 

{{-- SEND SMS FORM --}}
<div id="sendSMSModal" class="modal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content" id="uploadCollapseModal">
            ...
            <div class="modal-body">
                ...
                <div class="d-flex justify-content-between">
                    <h5 class="card-title fw-semibold mb-4 text-black">► SMS Notification</h5>
                </div>
                ...
                <div class="row">
                    <form>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <h5 class="text-center mt-3">Magandang araw! Ito ang abiso para sa susunod na pamamahagi ng food pack para sa inyong anak:</h5>
                                    <div class="col-md-4 mx-auto">
                                        <input type="text" id="sendDateField" class="form-control mb-3" placeholder="Petsa">
                                        <input type="text" id="sendTimeField" class="form-control mb-3" placeholder="Oras">
                                        <input type="text" id="sendLocationField" class="form-control" placeholder="Lugar">
                                    </div>
                        ...
                        <div class="modal-footer justify-content-between">
                            <button type="button" class="btn btn-default" onclick="SMSNotificationClearFields()" style="border:solid 1px gray">Close</button>
                            <button type="submit" class="btn btn-success">Send Message</button>
                        </div>
...
{{-- END OF REMINDER FORM --}} 


{{-- ADD DATE FORM --}}
<div id="addDateModal" class="modal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content" id="uploadCollapseModal">
...
<div class="card">
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <h5 class="card-title fw-semibold">► Complementary Feeding</h5>
            <div>
                <button type="button" class="btn btn-info mx-2 btnEnrollmentNotification">Enrollment Notification
                    </i></span>
                </button>
                <button type="button" class="btn btn-info mx-2 btnSMSNotification">SMS Notification
                    </i></span>
                </button>
                <!-- <button type="button" class="btn btn-success mx-2" data-toggle="collapse"
                    data-target="#create_card" aria-expanded="false" aria-controls="create_card">Send
                    SMS </i></span></button> -->
            </div>
        </div>
        <div>
...
$(document).on('click', '.btnRemoveCandidate', function() {
    ...
    inputElement.value = "Magandang araw! Ang inyong anak ay na-enroll sa Complementary Feeding Program dahil sa kanilang pangangailangan sa nutrisyon. Sila ay makatanggap ng mga food pack buwan-buwan. Asahan ang mga abiso kada buwan na may detalye sa petsa, lokasyon, at oras. Salamat po.";
        ...
        function SMSNotificationClearFields() {
                ...
                $('#sendDateField').val('');
                $('#sendTimeField').val('');
                $('#sendLocationField').val('');
                $('#sendSMSModal').modal('hide');
            }

        function reminderClearFields() {
            // Clear input fields
            $('#reminderDateField').val('');
            $('#reminderTimeField').val('');
            $('#reminderLocationField').val('');
    ...
    function closeAddDateModal() {
        ...
        $(document).ready(function()
        {
            ...
            $('.btnEnrollmentNotification').on('click', function()
            {
                $('#enrollmentNotificationModal').modal('show');
            });

            $('.btnSMSNotification').on('click', function()
            {
                    ...
                    [   
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row)
                            {
                                if (data == null)
                                {
                                    return `<div class="d-flex justify-content-around" style="vertical-align:top; text-align:center">
