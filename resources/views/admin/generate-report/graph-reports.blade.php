    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <div class="dropdown">
                    <button class="btn btn-secondary dropdown-toggle" type="button" id="monthDropdown" onclick="toggleDropdown()" aria-haspopup="true" aria-expanded="false">
                        Select Month
                    </button>
                    <div id="monthDropdownMenu" class="dropdown-menu" aria-labelledby="monthDropdown" style="display: none;">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        background: linear-gradient(to right, #cdffd8, #94b9ff); 
                        text-align: center; 
                        padding: 3%">Weight FOR LENGTH</h5>
...
<script>
    function toggleDropdown() {
        var dropdownMenu = document.getElementById("monthDropdownMenu");
...
$(document).ready(function() {
    ...
    function updateChartData() {
        ...
        var data1 = {
            ...
            datasets: [{
                data: setWeightForAgeStatusTable,
