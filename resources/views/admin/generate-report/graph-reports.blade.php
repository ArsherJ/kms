...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <h1>Graph Reports</h1>
            <!-- <button id="exportPdfButton" class="btn btn-dark mt-3">Export PDF</button> -->
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                        <h5 class="card-title" id="card1" style="font-size: 15px; 
                        font-weight: 1000; 
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title" id="card2"   style="font-size: 15px; 
                        font-weight: 1000; 
                        background: linear-gradient(to right, #cdffd8, #94b9ff); 
                        text-align: center; 
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title card3" id="card3"  style="font-size: 15px; 
                        font-weight: 1000; 
                        background: linear-gradient(to right, #cdffd8, #94b9ff); 
                        text-align: center; 
...
$(document).ready(function() {
    ...
    $("#exportPdfButton").click(function() {
        ...
        doc.setFontSize(25);
        doc.text('Graph Report', 122, 40); 

        var color1 = [205, 255, 216]; 
        var color2 = [148, 185, 255]; 
        var coordinates = [
            { x: 10, y: 51 },
            { x: 105, y: 51 },
            { x: 200, y: 51 }
        ...
        for (var j = 0; j < 3; j++) {
            ...
            for (var i = 0; i < 255; i++) {
                var gradientStep = [
                    Math.round(color1[0] + (i * (color2[0] - color1[0]) / 255)),
                Math.round(color1[1] + (i * (color2[1] - color1[1]) / 255)),
                Math.round(color1[2] + (i * (color2[2] - color1[2]) / 255))
                ];
                gradientSteps.push(gradientStep);
            }
            for (var i = 0; i < height; i++) {
                var gradientIndex = Math.round((i / height) * 255);
                var gradientColor = gradientSteps[gradientIndex];
                doc.setFillColor.apply(doc, gradientColor);
        ...
        doc.text('Weight For Age', 30, 60); 
        doc.text('Height/Length For Age', 113, 60); 
        doc.text('Weight For Length Age', 208, 60); 
        ...
        doc.setTextColor(0, 0, 0);
        doc.setFontSize(10);
        doc.text('Preferred By: _______________', 10, 200);
