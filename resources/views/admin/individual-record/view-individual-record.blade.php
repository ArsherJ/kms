                    ...
                    <div class="col-md-3">
                        <div class="card-body">
                            <div>
                                ...
                                <h6 style="padding:5px;  text-align:right">
                                    <strong>Weight for Height Status:</strong>
...
@section('scripts')
    <script>
        $(document).ready(function()
        {
            ...
            //script for calculating weight for height
    function calculateWgtHtstatus(height, ageInMonths, weight, sex) {
        let result = "Unknown";
        let statusClass = "";
        ...
        function setWgtHtStatus(SevereAcuteMalnutrition, ModerateAcuteMalnutrition, Normal, Overweight, Obese) {
            ...
            else if (weight > Normal && weight <= Overweight) { result = "Overweight"; statusClass = "bg-warning"; }
            else if (weight > Overweight && weight <= Obese || weight > Obese) { result = "Obese"; statusClass = "bg-danger" }
        }
            ...
            function getIndividualRecordIdRecord(id)
            {
                ...
                ({
                    ...
                    success: function(data)
                    {
                        ...
                        let lthtStatus = calculateWgtHtstatus(data.height, data.age_in_months, data.weight ,data.sex);
